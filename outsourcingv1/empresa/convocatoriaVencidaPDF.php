...
function Header()
{
    ...
    $this->Cell(70,10,utf8_decode('Reporte de Convocatorias Vencidas'),0,1,'C',0);
    // Salto de línea
    $this->Ln(10);
...
FROM empresas e INNER JOIN convocatorias c WHERE c.id_empresa=2 AND c.no_postulado=0";
